...
namespace Negocio
{
    public class TurnoNegocio
    {
        ...
        public List<Turno> ListarTurnosMedico(Medico medico, DateTime Fecha)
        {
        ...
        public List<Turno> ListarTurnosPaciente(Paciente paciente)
        {
            ...
            try
            {
                ...
                while (datos.lector.Read())
                {
                    ...
                    medico.Nombres = (string)datos.lector["MedicoNombre"];
                    medico.Apellidos = (string)datos.lector["MedicoApellidos"];
                    turno.Medico = medico;
        ...
        public void Modificar(Turno turno)
        {
            ...
            try
            {
                string consulta = @"UPDATE Turnos SET Fecha=@Fecha, Horario=@Hora, Estado=@Estado, Observaciones = @Observaciones
                                    WHERE IdTUrno=@Id";
                datos.setearConsulta(consulta);
                datos.setearParametro("@Fecha", turno.Fecha);
                datos.setearParametro("@Hora", turno.Hora);
